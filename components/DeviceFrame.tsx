...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="flex justify-center rounded-card bg-gradient-to-b from-plum-100 to-white p-8 shadow-media transition-shadow duration-300 ease-signature group-hover:shadow-media-hover">
