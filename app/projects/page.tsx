...
const projects: Project[] = copy.map((item, index) => {
  ...
  return { ...item, slug, href: slug === 'vip-mode' ? '/projects/vip-mode' : `#${slug}`, linkLabel, index: String(index + 1).padStart(2, '0'), visual }
})
